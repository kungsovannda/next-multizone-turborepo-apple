    ...
    <nav className="bg-white/70 backdrop-blur-2xl fixed w-full to-0 z-50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-center h-11 gap-10 text-black">
          ...
          <a href="/mac" className="text-xs font-normal">
            Mac
          </a>
          <a href="/ipad" className="text-xs font-normal ">
            iPad
          </a>
          ...
          >
            ...
            {itemCount > 0 && (
              <span className="absolute top-1 -right-3 bg-black text-white text-[10px]  rounded-full h-5 w-5 flex items-center justify-center">
                {itemCount}
              </span>
            )}
          </a>
